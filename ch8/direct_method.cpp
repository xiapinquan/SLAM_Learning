...
private:
    ...
    Sophus::SE3d &T21;
    VecVector2d projection;  //tou yin
    ...
    for(size_t i = range.start;i<range.end;i++){
        ...
        for(int x=-half_patch_size ; x<=half_patch_size ; x++){
            for(int y = -half_patch_size ; y<=half_patch_size ; y++){
                ...
                J_img_pixel = Eigen::Vector2d(0.5 * (GetPixelValue(img2,u+x+1,v+y) - GetPixelValue(img2,u+x-1,v+y)),
