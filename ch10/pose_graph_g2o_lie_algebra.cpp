...
public:
    ...
    virtual void oplusImpl(const double *update) override {
        Matrix<double,6,1> up;
        up<<update[0],update[1],update[2],update[3],update[4],update[5],update[6];
        _estimate = SE3d::exp(up) * _estimate;
    }
};
...
public:
    ...
    bool read(istream &is) override {
        ...
        Quaterniond q = Quaterniond(data[6],data[3],data[4],data[5]);
        q.normalize();
        setMeasurement(SE3d(q
